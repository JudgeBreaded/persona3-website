...
const ITEMS = [
  {
    id: "twitch", label: "TWITCH", handle: "@yourname", href: "https://twitch.tv/judgebreaded", icon: "🎮", barIcon: icon1, bars: 1, newBars: [0], counts: ["56"],
  ...
  {
    id: "instagram", label: "INSTAGRAM", handle: "@brettmackinnon9", href: "https://instagram.com/brettmackinnon9/", icon: "📷", barIcon: icon2, bars: 5, newBars: [0], counts: ["3.4M", "2.5M", "676K", "412K", "198K"],
    links: ["instagram.com/p/DVb3YbikZ9o", "www.instagram.com/tinychihuahuacedric/reel/DXulbClCTWh", "www.instagram.com/p/CRTPgIGApJY", "www.instagram.com/tinychihuahuacedric/p/DXzkyq9Fovq/", "www.instagram.com/p/DUYef8rDvMg/"],
    stats: [
  ...
  {
    id: "LinkedIn", label: "LinkedIn", handle: "@yourhandle", href: "https://tiktok.com/@yourhandle", icon: "🎵", barIcon: icon3, bars: 1, newBars: [0], counts: ["5.1M"],
    links: ["www.linkedin.com/in/brett-mackinnon-19936111a"],
    stats: [
